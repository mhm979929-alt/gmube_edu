...
function avatarHtml(name, avatarUrl, size = 40) {
  if (avatarUrl) return `<img src="${escHtml(avatarUrl)}" class="avatar-img" style="width:${size}px;height:${size}px;border-radius:50%;object-fit:cover" onerror="this.outerHTML=avatarInitial('${escHtml(name)}',${size})">`;
